# PRD — Iberian Electrical Products Wholesale Sector Dashboard

## 1. Objetivo
Crear una web app pública, simple y visual, para analizar el sector **Iberian Electrical Products Wholesale Sector** a partir de dos archivos Excel cargados manualmente.
...
- desde **NOMBRE** hasta **WC/T/o** se tratará como dato estándar,
...
- Sector inicial único: **Iberian Electrical Products Wholesale Sector**
- Importación: **manual**
