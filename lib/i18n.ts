...
const messages: Record<Locale, MessageCatalog> = {
  en: {
    metadata: {
      title: "Iberian Electrical Products Wholesale Sector",
      description: "Public sector dashboard for the Iberian Electrical Products Wholesale Sector.",
    },
    language: {
      label: "Language",
    ...
    sidebar: {
      ...
      title: "Iberian Electrical Products Wholesale Sector",
      description: "Market mapping, company benchmarking, and ownership review in one place.",
      nav: {
        overview: "Overview",
        companies: "Companies",
        geography: "Geography",
    ...
    attributes: {
      ...
      electronics_communications: "Electronics Communications",
  ...
  es: {
    metadata: {
      title: "Sector Mayorista Ibérico de Productos Eléctricos",
      description: "Dashboard público del sector mayorista ibérico de productos eléctricos.",
    },
    language: {
      label: "Idioma",
      options: { en: "EN", es: "ES", pt: "PT" },
    ...
    sidebar: {
      ...
      title: "Sector Mayorista Ibérico de Productos Eléctricos",
      description: "Mapa del mercado, benchmarking de compañías y análisis de propiedad en un solo lugar.",
      nav: {
        overview: "Resumen",
        companies: "Compañías",
        geography: "Geografía",
    ...
    attributes: {
      cables_connectors: "Cables y conectores",
      electronics_communications: "Electrónica y comunicaciones",
      automation_control: "Automatización y control",
      installation_materials: "Materiales de instalación",
      lighting: "Iluminación",
      energy_distribution: "Distribución de energía",
      electric_mobility: "Movilidad eléctrica",
    },
  },
  pt: {
    metadata: {
      title: "Setor Ibérico Grossista de Produtos Elétricos",
      description: "Painel público do setor ibérico grossista de produtos elétricos.",
    },
    language: {
      label: "Idioma",
      options: { en: "EN", es: "ES", pt: "PT" },
    ...
    sidebar: {
      ...
      title: "Setor Ibérico Grossista de Produtos Elétricos",
      description: "Mapeamento do mercado, benchmarking de empresas e análise de propriedade num só lugar.",
      nav: {
    ...
    attributes: {
      cables_connectors: "Cabos e conectores",
      electronics_communications: "Eletrónica e comunicações",
      automation_control: "Automação e controlo",
      installation_materials: "Materiais de instalação",
      lighting: "Iluminação",
      energy_distribution: "Distribuição de energia",
      electric_mobility: "Mobilidade elétrica",
    },
  },
};
