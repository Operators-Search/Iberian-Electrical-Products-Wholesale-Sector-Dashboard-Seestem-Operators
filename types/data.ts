export const ATTRIBUTE_DEFINITIONS = [
  { key: "cables_connectors", label: "Cables Connectors" },
  { key: "electronics_communications", label: "Electronics Communications" },
  { key: "automation_control", label: "Automation Control" },
  { key: "installation_materials", label: "Installation Materials" },
  { key: "lighting", label: "Lighting" },
  { key: "energy_distribution", label: "Energy Distribution" },
  { key: "electric_mobility", label: "Electric Mobility" },
] as const;
